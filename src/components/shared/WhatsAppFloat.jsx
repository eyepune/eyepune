...
export default function WhatsAppFloat() {
    ...
    return (
        <div className="fixed bottom-6 left-6 z-50 pointer-events-none" style={{ isolation: 'isolate' }}>
                ...
                {showTooltip && (
                    ...
                    >
                        ...
                        <p className="text-gray-400 text-xs leading-relaxed">
                            Free consultation in minutes.<br />Mon–Sat, 9am–7pm IST.
                        </p>
                    </motion.div>
                )}
            </AnimatePresence>
            ...
            >
                {/* Pulse ring — kept inside overflow-hidden wrapper */}
                <span
                    className="absolute inset-0 rounded-full animate-ping"
                    style={{ background: 'rgba(37,211,102,0.3)', zIndex: 0 }}
                />
                <svg viewBox="0 0 24 24" className="w-7 h-7 fill-white relative" style={{ zIndex: 1 }}>
