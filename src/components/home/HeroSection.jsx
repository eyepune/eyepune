...
export default function HeroSection() {
    ...
    return (
        <section ref={heroRef} className="relative min-h-screen pt-20 pb-8 flex items-center justify-center overflow-hidden bg-[#040404]">
            {/* Background elements */}
            ...
            <div className="max-w-7xl mx-auto px-6 relative z-10 w-full">
                <div className="grid lg:grid-cols-2 gap-16 items-center">
                    ...
                    >
                        ...
                        {/* Trust markers */}
                        <div className="flex items-center gap-8 border-t border-white/5 pt-8 mb-6">
