...
const PAGE_MAP = {
  ...
  'Client-Reports': Client_Dashboard,
  'Client-Files': Client_Dashboard,
  'Client-Documents': Client_Dashboard,
  'Client-Messages': Client_Dashboard,
  'Client-Feedback': Client_Dashboard,
