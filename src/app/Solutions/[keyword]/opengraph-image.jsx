...
// Image metadata
export const alt = 'EyE PunE AI Solutions';
export const size = {
  width: 1200,
  height: 630,
};
...
export default async function Image({ params }) {
  // Format the keyword beautifully
  const rawKeyword = params.keyword || 'growth';
  ...
  return new ImageResponse(
    (
      ...
      >
        ...
        >
          Dominate your market with our elite, AI-driven digital growth frameworks.
        </div>
      </div>
    ),
    {
