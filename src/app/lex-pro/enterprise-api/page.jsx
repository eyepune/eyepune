...
import { ArrowLeft, Code, ChevronRight, PhoneCall } from 'lucide-react';
    ...
    return (
        <div className="min-h-screen bg-[#0A0F1C] text-gray-100 font-sans selection:bg-blue-500/30 overflow-x-hidden">
            ...
            <section className="relative z-10 pt-12 pb-24 px-4 max-w-5xl mx-auto text-center flex flex-col items-center">
                ...
                <Code className="w-12 h-12 md:w-16 md:h-16 text-blue-400 mb-8" />
                <motion.h1 
                    initial={{ opacity: 0, y: 20 }}
                    animate={{ opacity: 1, y: 0 }}
                    className="text-4xl md:text-6xl lg:text-7xl font-black tracking-tighter mb-6 md:mb-8 leading-[1.1]"
                >
                    Embed LexPro with our <br className="hidden md:block"/>
                    <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-slate-300">Enterprise API.</span>
                </motion.h1>
                <p className="text-base md:text-xl text-gray-400 max-w-2xl mb-10 md:mb-12 leading-relaxed px-2">
                    Integrate India-compliant legal drafting, clause risk analysis, and signature auditing directly into your own ERP, CRM, or HRMS platform.
                </p>
            ...
            <LexProLeadModal 
                ...
                sourcePage="/lex-pro/enterprise-api" 
            />
        </div>
    )
}
