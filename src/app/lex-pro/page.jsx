        ...
        <div className="min-h-screen bg-[#0A0F1C] text-gray-100 font-sans overflow-x-hidden selection:bg-blue-500/30 selection:text-blue-200">
            ...
            <nav className="relative z-50 flex items-center justify-between px-8 py-6 max-w-7xl mx-auto">
                <Link href="/lex-pro" className="flex items-center">
                    <img src="/lexpro-logo.png" alt="LexPro Logo" className="h-20 md:h-28 w-auto object-contain grayscale invert brightness-200 mix-blend-screen opacity-90 hover:opacity-100 transition-opacity" />
                </Link>
