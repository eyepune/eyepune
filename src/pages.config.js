...
export const PAGES = {
    ...
    "Client-Reports": clientDashboard,
    "Client-Files": clientDashboard,
    "Client-Documents": clientDashboard,
    "Client-Messages": clientDashboard,
    "Client-Feedback": clientDashboard,
    "Contact": Contact,
    "Home": Home,
