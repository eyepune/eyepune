                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6">
                    <div className="flex items-center justify-between h-20">
                        ...
                        <Link href={createPageUrl("Home")} className="flex-shrink-0 flex flex-col items-center justify-center">
                            ...
                            <span className="text-[8px] sm:text-[9px] tracking-[0.2em] uppercase text-red-500 font-bold mt-1 text-center">Connect · Engage · Grow</span>
                        </Link>
                        )}
                        {(isAdminPage || isClientPage) && (
                        ...
                        <div className="grid sm:grid-cols-2 lg:grid-cols-6 gap-10 lg:gap-12 mb-14 text-center sm:text-left">
                            ...
                            <div className="sm:col-span-2 lg:col-span-2 flex flex-col items-center sm:items-start">
                                <div className="mb-5 flex flex-col items-center justify-center">
                                    <Logo variant="dark" size="sm" />
                                    <span className="text-[10px] tracking-[0.2em] uppercase text-red-500 font-bold mt-2 text-center">Connect · Engage · Grow</span>
                                </div>
