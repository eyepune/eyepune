...
import { ArrowRight, Globe, Zap, ShieldCheck, Smartphone, Code2, BarChart3, Search, TrendingUp } from 'lucide-react';
        ...
        <>
                    ...
                    <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
                        {features.map((f, i) => (
                            <motion.div key={i} initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: i * 0.08 }}
                                className="group p-8 rounded-2xl bg-card border border-border/50 hover:border-red-500/30 transition-colors relative overflow-hidden"
                            >
                ...
                <div className="relative z-10 flex flex-col md:flex-row items-center gap-8">
                  <div className="md:w-3/5 text-center md:text-left">
                    ...
                    <h3 className="text-2xl md:text-3xl font-black mb-4 leading-tight">
                      The 2026 <span className="text-red-500">Website Development</span> Growth Blueprint
                    </h3>
                    ...
                    <LeadMagnetForm keyword="Website Development Strategy" />
                  </div>
                  ...
                  <div className="md:w-2/5 flex justify-center">
                    <div className="relative w-48 h-64 bg-[#0a0a0a] border border-white/10 rounded-xl shadow-2xl overflow-hidden transform rotate-3 hover:rotate-0 transition-transform duration-500">
                      ...
                      <div className="p-6 pt-10 flex flex-col items-center text-center h-full">
                        ...
                        <div className="font-black text-white text-lg leading-tight">Web Development Framework</div>
                      </div>
                    </div>
                  </div>
                </div>
            ...
            <div className="max-w-4xl mx-auto text-center p-12 rounded-3xl bg-gradient-to-b from-red-950/40 to-black border border-red-900/30 relative overflow-hidden mb-24 mt-12">
              ...
              <h2 className="text-2xl sm:text-3xl md:text-4xl font-black mb-4 md:mb-6 relative z-10 px-2 leading-tight">
                Let's Build Your <span className="text-red-500 block sm:inline mt-1 sm:mt-0 pb-1">Dream Website</span>
              </h2>
